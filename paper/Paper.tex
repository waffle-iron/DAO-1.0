...
Creation ratio increases during the Creation Phase could lead to a situation where a single contributor, having bought tokens at the initial Creation ratio, could split the DAO immediately after the sale ends, thereby receiving more ether than they put in due to other contributors having a higher Creation ratio (\cite{GriffDiscussion}).
